...
class DefSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('role')->insert([
            ['created_by' => '1', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'USER'],
            ['created_by' => '1', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'AGENT'],
        ]);
        ...
        DB::table('transaction_codes')->insert([
            ...
            ['created_by' => '1', 'created_at' => date("Y-m-d h:i:sa"), 'code' => '060004', 'description'=>'VIRTUAL ACCOUNT -  PAYMENT',            'description_malay'=>'VIRTUAL ACCOUNT -  BAYARAN'],
            ...
            ['created_by' => '1', 'created_at' => date("Y-m-d h:i:sa"), 'code' => '060009', 'description'=>'VIRTUAL ACCOUNT -  TOP UP',             'description_malay'=>'VIRTUAL ACCOUNT -  TAMBAH NILAI'],
            ...
            ['created_by' => '1', 'created_at' => date("Y-m-d h:i:sa"), 'code' => '060909', 'description'=>'VIRTUAL ACCOUNT - REVERSAL TOP UP',     'description_malay'=>'VIRTUAL ACCOUNT - PEMBATALAN TAMBAH NILAI'],
            ...
            ['created_by' => '1', 'created_at' => date("Y-m-d h:i:sa"), 'code' => '070004', 'description'=>'ZAKAT -  PAYMENT',                      'description_malay'=>'ZAKAT -  BAYARAN'],
            ['created_by' => '1', 'created_at' => date("Y-m-d h:i:sa"), 'code' => '070904', 'description'=>'ZAKAT - REVERSAL PAYMENT',              'description_malay'=>'ZAKAT - PEMBATALAN BAYARAN'],
        ]);
