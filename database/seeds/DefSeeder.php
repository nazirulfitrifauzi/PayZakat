...
class DefSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('state')->insert([
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'JOHOR'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'KEDAH'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'KELANTAN'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'MELAKA'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'NEGERI SEMBILAN'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'PAHANG'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'PERAK'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'PERLIS'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'PULAU PINANG'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'SABAH'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'SARAWAK'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'SELANGOR'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'TERENGGANU'],
            ['created_by' => '0', 'created_at' => date("Y-m-d h:i:sa"), 'description'=>'WILAYAH PERSEKUTUAN'],
        ]);
