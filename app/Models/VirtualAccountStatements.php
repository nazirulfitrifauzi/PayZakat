...
class VirtualAccountStatements extends Model
{
    use SoftDeletes;
    public $timestamps = true;

    protected $table = 'virtual_account_statements';
    protected $guarded = [];

    public function virtual_account(){
        return $this->belongsTo('App\Models\VirtualAccounts', 'virtual_account_id', 'id');
    }
