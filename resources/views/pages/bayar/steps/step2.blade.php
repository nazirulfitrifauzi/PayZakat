                        ...
                        <x-general.card class="p-5 bg-teal-500 shadow">
                              <div class="flex-auto sm:flex">
                                    ...
                                    <div class="mt-4 sm:mt-0 flex items-center">
                                          <x-general.modal.trigger target="topup" class="p-4 text-xs font-semibold tracking-widest text-white whitespace-no-wrap transition duration-300 ease-in-out bg-teal-600 rounded-md hover:bg-teal-700">
                                                Bayar Sekarang
