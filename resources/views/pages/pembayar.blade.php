       ...
       <!-- Content -->
        <div class="mt-8">
            ...
            <div class="mx-auto px-0 my-3 text-lg leading-6 font-medium text-cool-gray-900 sm:px-6 lg:px-8">
                <div class="bg-white sm:rounded-lg shadow px-5 py-3 flex flex-col md:flex-row">
                    <div class="inline-flex">
                        <button class="bg-teal-500 hover:bg-teal-500 text-white hover:text-white py-2 px-4 rounded-l-lg border border-teal-500 text-sm focus:outline-none transition duration-500 ease-in-out tracking-wider">
                            Bulanan
                        </button>
                        <button class="bg-white hover:bg-teal-500 hover:text-white text-gray-800 py-2 px-4 rounded-r-lg border border-teal-500 text-sm focus:outline-none transition duration-500 ease-in-out tracking-wider">
                            Tahunan
                        </button>
                    </div>
                    <div class="mt-3 ml-0 md:mt-0 md:ml-5">
                        <form>
                            <div class="inline-block relative w-40">
                                <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-3 pr-8 rounded-lg leading-tight focus:outline-none text-sm">
                                    <option>2020</option>
                                    <option>2019</option>
                                    <option>2018</option>
                                    <option>2017</option>
