<x-form.basic-form action="submit">
    <x-slot name="content">
        ...
        <x-form.dropdown class="sm:col-span-2" label="Dicadangkan oleh saya" value="recommender_flag" default="yes">
            <option value="1">Ya</option>
            <option value="0">Tidak</option>
        </x-form.dropdown>

        <x-form.input class="sm:col-span-2" label="Nama Pencadang" value="recommender_name" livewire="wire:model.lazy=recommender_name wire:loading.attr=readonly wire:loading.class=bg-gray-300 wire:target=submit"/>
        <x-form.input class="sm:col-span-2" label="No Kad Pengenalan Pencadang" value="recommender_ic" livewire="wire:model.lazy=recommender_ic wire:loading.attr=readonly wire:loading.class=bg-gray-300 wire:target=submit"/>
        <x-form.input class="sm:col-span-2" label="Telefon Bimbit Pencadang" value="recommender_phone" livewire="wire:model.lazy=recommender_phone wire:loading.attr=readonly wire:loading.class=bg-gray-300 wire:target=submit"/>
        <x-form.input class="sm:col-span-2" label="E-mail Pencandang" value="recommender_email" livewire="wire:model.lazy=recommender_email wire:loading.attr=readonly wire:loading.class=bg-gray-300 wire:target=submit"/>
