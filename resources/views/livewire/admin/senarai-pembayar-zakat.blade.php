<div>
    ...
    <x-general.table>
        <x-slot name="thead">
            ...
            <x-general.table-header class="text-left" value="Pendaftar" sort="agent_id" livewire="wire:click.prevent=sortBy('agent_id')"/>
                ...
                <tr>
                    ...
                    <x-general.table-body colspan="" class="font-medium text-right">
                        <div class="flex justify-center" x-data="{ open: false }">
                            ...
                            {{-- modal screening --}}
                            @include('pages.admin.pengguna.modalScreeningPembayarZakat')
                        </div>
                    </x-general.table-body>
                </tr>
            @empty
